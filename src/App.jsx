...
import { Package, Truck, AlertCircle, X, Check, Clock } from 'lucide-react';
...
const ShipmentsTable = lazy(() => import('./components/ShipmentsTable'));
        ...
        <div className="max-h-96 overflow-y-auto">
          {notifications.length === 0 ? (
            ...
            notifications.map(notif => (
              <div
                key={notif.id}
                className={`p-3 ${theme === 'dark' ? 'border-gray-700' : 'border-gray-100'} border-b ${theme === 'dark' ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} cursor-pointer ${notif.read
